...
function timelineScrollListener(sliderNode, timelinePosArray) {
...
function main() {
    const timelinePositionsArray = calculateAllTimelinePositions();
    const monthsElapsed = calculateTimelineLength();
    const timelineSliderNode = renderTimeline(monthsElapsed);

    timelineScrollListener(timelineSliderNode, timelinePositionsArray);
}
